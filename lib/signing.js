...
export async function signApkFile(apkFile, signingKeyFile, alias, keyStorePassword, keyPassword, doZipAlign, usePageAlign) {
...
export async function signAabFile(aabFile, signingKeyFile, alias, keyStorePassword, keyPassword) {
